                ...
                else
                {
                    ...
                    if (request != null && Convert.ToBoolean(request.Attributes["IsEnable"].Value) == true)
                    {
                        try
                        {
                            ...
                            #region browserCache --commented as it is done at the begining of the request
                            ...
                            if ( !(fileNameExt != string.Empty && _vuScriptXml.Attributes["exclutionfiletypes"].Value.Contains(fileNameExt.Replace(".", string.Empty).Trim().ToLower()) == true))
                            {
                                ...
                                if (Convert.ToBoolean(_vuScriptXml.Attributes["dynamicreqenable"].Value) == true && !(_browserCache == true) && Convert.ToBoolean(req.RequestNode.Attributes["Excludesecondaryreq"].Value) == true)
