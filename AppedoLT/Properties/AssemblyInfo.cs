...
[assembly: AssemblyVersion("3.3.050.0")]
[assembly: AssemblyFileVersion("3.3.050.0")]
//3.3.050 - Bug Fix - When browser cache enabled, caching happens for all the script that does not have the cache enabled.
//3.3.049 - Bug Fix - When multiple scripts were running in iteration, on completion of iteration of the first scripts, all the scripts are getting stopped
