var tabdropdown = {
    ...
    dropit: function(obj, e, dropmenuID) {
        ...
        if (this.ie || this.firefox) {
            ...
            this.dropmenuobj = document.getElementById('ccadminHeader_' + dropmenuID)
    ...
    init: function(menuid, dselected) {
        ...
        for (var i = 0; i < menuitems.length; i++) {
            if (menuitems[i].getAttribute("rel")) {
                ...
                document.getElementById('ccadminHeader_' + relvalue).firstlink = document.getElementById('ccadminHeader_' + relvalue).getElementsByTagName("a")[0]
...
function selVMI(menuId, selIndex) {
    var spans = document.getElementById(menuId).getElementsByTagName("span");
    spans.item(selIndex).className = "menuSel";
}