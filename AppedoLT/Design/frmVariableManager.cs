...
4.First Character should be alphabet or Underscore.");
        ...
        public XmlNode GetVariableInfo(XmlNode var)
        {
            ...
            else if (rbtnEachOccurrence.Checked == true) variable.Attributes.Append(_variableXml.GetAttribute("policy", "eachoccurrence"));
        ...
        private void MakeReadOnly()
        {
            ...
            rbtnGlobal.Enabled = rbtnEachUser.Enabled = rbtnEachIteration.Enabled =rbtnEachOccurrence.Enabled= false;
        ...
        private void ReleaseReadOnly()
        {
            ...
            rbtnGlobal.Enabled = rbtnEachUser.Enabled = rbtnEachIteration.Enabled = rbtnEachOccurrence.Enabled = true;
        ...
        private void Populate(XmlNode var)
        {
            try
            {
                ...
                else if (var.Attributes["policy"].Value == "eachoccurrence") rbtnEachOccurrence.Checked = true;
